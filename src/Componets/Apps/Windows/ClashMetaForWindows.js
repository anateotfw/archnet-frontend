                        ...
                        <div className="flex flex-wrap mt-8 gap-8 md:grid-cols-2 lg:grid-cols-3">
                            ...
                            >
                                ...
                                <p  className="mt-1 text-sm text-gray-300" style={{direction: "rtl"}}>
                                   در پنل کاربری خود بر روی گزینه Windows کلیک کرده و سپس برنامه ClashVerge را انتخاب کنید و در نهایت بر روی دانلود کلیک کنید. در حالی که برنامه را دانلود میکنید بر روی گزینه "کپی کردن لینک اتصال" کلیک کرده تا لینک اتصال اشتراک خود را کپی کنید.
...
export default ClashMetaForWindows;