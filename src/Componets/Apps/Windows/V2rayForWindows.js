               ...
               <section className="bg-gray-900 text-white">
                   ...
                   >
                       <div className="mt-12 text-center">
                           ...
                           <h1> V2rayNG آموزش فعال سازی  <i className="text-transparent bg-clip-text bg-gradient-to-br from-blue-300 to-purple-300 ease-linear transition hover:hue-rotate-[90deg] duration-300" style={{fontStyle: "normal"}}> آرچ نت </i> با نرم افزار </h1>
                       </div>
                       ...
                       <div className="flex flex-wrap mt-8 gap-8 md:grid-cols-2 lg:grid-cols-3">
                           ...
                           >
                               ...
                               <img src={step9V2rayWindows}/>

                               <h2 className="mt-4 text-xl font-bold purpleText" style={{direction: "rtl"}}>فعال شدن</h2>
                           ...
                           >
                               ...
                               <img src={step10V2rayWindows}/>

                               <h2 className="mt-4 text-xl font-bold purpleText" style={{direction: "rtl"}}>آپدیت و فعال شدن</h2>
...
export default V2rayForWindows;